...
namespace aoc::utils{
	...
	public:
		...
		constexpr string_literal<N>(const string_literal<N>&) = default;
		constexpr string_literal<N>(string_literal<N>&&) = default;
		constexpr string_literal<N>& operator=(const string_literal<N>&) = default;
		constexpr string_literal<N>& operator=(string_literal<N>&&) = default;
